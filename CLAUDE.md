...
### Modules
Visitor Sync · Visitor Registration (guided multi-pose capture added 2026-09-03) · Kiosk Entry · Kiosk Self-Service (Gatesale/Truck, guided multi-pose capture added 2026-09-03) · Face Matching (multi-pose scoring/ambiguity upgrade, Phases A–D added 2026-09-03, Phase E not done) · Google Sheets Integration · Session Auto-Resolution · Facility Master Data (live site-binding target since the 2026-08-27 cutover) · Admin Management · Downtime Matrix PDF Import (Phase 1 — parse/validate/preview, added 2026-08-27; Phase 2 — Save to Production mapping into `downtime_matrix`/`downtime_stationary`, added 2026-08-28) · Authentication & Authorization · Audit Logging (cross-cutting)
