...
### Modules
Visitor Sync · Visitor Registration (guided multi-pose capture added 2026-09-03) · Kiosk Entry (break restriction via `facility_list.is_break_enabled` added 2026-09-03) · Kiosk Self-Service (Gatesale/Truck, guided multi-pose capture added 2026-09-03; Gatesale facility-eligibility flag added 2026-09-03; Truck facility-eligibility flag, mirroring Gatesale's, added 2026-09-03) · Face Matching (multi-pose scoring/ambiguity upgrade, Phases A–D added 2026-09-03, Phase E not done) · Google Sheets Integration · Session Auto-Resolution · Facility Master Data (live site-binding target since the 2026-08-27 cutover; `is_gs`/`is_break_enabled`/`is_truck` flags added 2026-09-03) · Admin Management (Facility Configuration checkbox-grid module added 2026-09-03) · Downtime Matrix PDF Import (Phase 1 — parse/validate/preview, added 2026-08-27; Phase 2 — Save to Production mapping into `downtime_matrix`/`downtime_stationary`, added 2026-08-28) · Authentication & Authorization · Audit Logging (cross-cutting)
