...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('admin/kiosks', \App\Http\Controllers\Admin\KioskDeviceController::class)->middleware('permission:kiosks.manage')->parameter('kiosk_device', 'kiosk_device');
