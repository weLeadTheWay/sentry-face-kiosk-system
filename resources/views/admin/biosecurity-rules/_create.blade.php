<div class="content-header"><h2 class="content-title">Add Biosecurity Rule</h2></div>
        ...
        <div class="form-group @error('area_type') has-error @enderror"><label for="area_type">Area Type</label><input type="text" id="area_type" name="area_type">@error('area_type')<div class="error-message">{{ $message }}</div>@enderror</div>
        ...
        <div class="form-group @error('access_level') has-error @enderror"><label for="access_level">Access Level *</label><input type="text" id="access_level" name="access_level" required>@error('access_level')<div class="error-message">{{ $message }}</div>@enderror</div>
        ...
        <div class="form-actions"><button type="submit" class="btn">Create</button><a href="{{ route('biosecurity-rules.index') }}" class="btn btn-secondary ajax-link">Cancel</a></div></form>
</div>
