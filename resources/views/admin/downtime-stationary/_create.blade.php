...
<div class="content-header"><h2 class="content-title">Add Downtime Stationary Rule</h2></div>
        ...
        <div class="form-group @error('minimum_downtime_hours') has-error @enderror"><label for="minimum_downtime_hours">Minimum Downtime (hours)</label><input type="number" step="0.01" id="minimum_downtime_hours" name="minimum_downtime_hours">@error('minimum_downtime_hours')<div class="error-message">{{ $message }}</div>@enderror</div>

        <div class="form-group @error('max_downtime_hours') has-error @enderror"><label for="max_downtime_hours">Maximum Downtime (hours)</label><input type="number" step="0.01" id="max_downtime_hours" name="max_downtime_hours">@error('max_downtime_hours')<div class="error-message">{{ $message }}</div>@enderror</div>
